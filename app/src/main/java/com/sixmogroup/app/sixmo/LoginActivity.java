    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        siginIn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(CommonUtils.validateEmail(email.getText().toString())==true && CommonUtils.validateMobile(mobile.getText().toString())==true) {
                    ...
                    Snackbar.make(layout, "Check Email or Phone and try again", Snackbar.LENGTH_LONG).show();
                }
            }
        });
    }
